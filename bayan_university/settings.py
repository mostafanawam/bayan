"""
Django settings for bayan_university project.
...
SECRET_KEY = 'django-insecure-iuxw6z5mkn(q+atp1=oq^g5#m^ecid#)rar=%37qr4vs#@lf#a'
...
ROOT_URLCONF = 'bayan_university.urls'
...
WSGI_APPLICATION = 'bayan_university.wsgi.application'
...
EMAIL_HOST_PASSWORD=os.getenv("EMAIL_HOST_PASSWORD", "ghjs bsko luov zlqi" )     
